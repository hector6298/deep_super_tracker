...
def hungarian_assign(distance):
    """Execute the Hungarian algorithm with a distance matrix.

    Parameters:
    ===========
    - distance: 2D np.array
        The distance matrix.
    
    Returns:
    ===========
    - assigned_rows: np.ndarray
    - assigned_columns: np.ndarray
    """
    # Perform the hungarian algorithm
    return  linear_assignment(distance)